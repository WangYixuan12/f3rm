...
from f3rm.features.dinov2_extract import DINOv2Args, extract_dinov2_features, extract_dinov2_and_sam_features
...
feat_type_to_extract_fn = {
    ...
    "DINOv2_SAM": extract_dinov2_and_sam_features
}
